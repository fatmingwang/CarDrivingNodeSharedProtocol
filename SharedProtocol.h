...
#define	LAZY_HEADER_STAR(TYPE)								struct TYPE{int8 i8MagicID[MAGIC_ID_COUNT]; int16	i16PacketSize; uint16	i16CheckSum; int16 i16Message;
...
LAZY_HEADER_STAR(sCar_A_TO_B_eCDNM_S2C_CAR_GO_TO_DESTINATION_ID_1)
	int16	iTagCount;//or do if Tag ID is -1 end?,2
	int16	i16TagID[CAR_A_TO_B_DATA_LENGTH];//160
...
LAZY_HEADER_STAR(sCar_A_TO_B_eCDNM_S2C_CAR_GO_TO_DESTINATION_SPEED_2)
	int16	iTagCount;//or do if Tag ID is -1 end?
	int16	i16Speed[CAR_A_TO_B_DATA_LENGTH];
...
LAZY_HEADER_STAR(sCar_A_TO_B_eCDNM_S2C_CAR_GO_TO_DESTINATION_ANGLE_3)
	int16	iCount;
	int8	i8AngleType[CAR_A_TO_B_DATA_LENGTH];
...
LAZY_HEADER_STAR(sCar_A_TO_B_eCDNM_S2C_CAR_GO_TO_DESTINATION_DISTANCE_4)
	int16	iCount;
	int16	i16Distance[CAR_A_TO_B_DATA_LENGTH];
