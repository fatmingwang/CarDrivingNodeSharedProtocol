...
enum eNodeType
{
	...
	eNT_WAIT_TO_COLLECT_GARBAGE_POINT_POINT,
...
static const wchar_t* g_sstrNotyTypeString[eNT_MAX] =
{
	...
	L"WaitToCollectGarbagePoint",//eNT_WAIT_TO_COLLECT_GARBAGE_POINT_POINT
	L"CollectGarbagePoint",//eNT_COLLECT_GARBAGE_POINT
	//L"Max"//,eNT_MAX,
};
...
static int16 g_si16NodeTypeSpeed[eNT_MAX] = 
{
	...
	10,//eNT_WAIT_TO_COLLECT_GARBAGE_POINT_POINT
	10,//eNT_COLLECT_GARBAGE_POINT
};
