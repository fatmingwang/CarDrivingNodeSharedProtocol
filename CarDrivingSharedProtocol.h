...
//
#define		CAR_DRIVING_SERVER_NETWORK_MESSAGE_VERSION			20220111
...
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_TELL_SERVER_WHO_YOU_ARE_REQUEST)
	int					iVersion;
...
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_TELL_SERVER_WHO_YOU_ARE_REQUEST)
#pragma pack(pop)
//
#pragma pack(push,1)
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_STAR(eCDNM_C2S_TELL_SERVER_WHO_YOU_ARE_RESULT)
	int		iCarID;
...
//LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR explain
//sample
...
//
#pragma pack(push,1)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_C2S_CAR_STATUS)
	int				iCarID;
...
#pragma pack(push,1)// push current alignment to stack,set alignment to n byte boundary
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_CAR_GO_TO_DESTINATION_REQUEST)
	//node(RFID) count
...
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_CAR_GO_TO_DESTINATION_REQUEST)
#pragma pack(pop)

#pragma pack(push,1)
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_STAR(eCDNM_C2S_CAR_GO_TO_DESTINATION_RESULT)
	int				iCarID;
	int				iCount;
	unsigned int	uiAskCarToGoCommandUID;
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_END(eCDNM_C2S_CAR_GO_TO_DESTINATION_RESULT)
#pragma pack(pop)

LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_ASK_CAR_STOP)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_ASK_CAR_STOP)


LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_VOICE_TEST)
	int iVoiceID;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_VOICE_TEST)
...
#define	LED_UPDATE_NAME_MEAL_ARRIVE			L"MealArrive"
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_LED_HW_TEST)
	unsigned char	ucColor[3];
	int				iSpeed;
	float			fLimunance;
	char			strUpdateName[20];
	bool			bOnlyChangeUpdateName;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_LED_HW_TEST)
...
#pragma pack(push,1)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_LID_MOTOR_HW_TEST)
	int		iAngle;
	int		iType;//eLidBehaviorType
	int		iSpeed;
	int		iAcc;
	bool	bSaveFile;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_LID_MOTOR_HW_TEST)
#pragma pack(pop)



#pragma pack(push,1)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_CANCEL_DELIVER_ORDER_REQUEST)
	RFID_DATA_TYPE	i64StopRFID;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_CANCEL_DELIVER_ORDER_REQUEST)
#pragma pack(pop)
//result code 0 car pass over,1 car will stop at chancel deliver point
#pragma pack(push,1)
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_STAR(eCDNM_C2S_CANCEL_DELIVER_ORDER_RESULT)
	int	iCarID;
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_END(eCDNM_C2S_CANCEL_DELIVER_ORDER_RESULT)
#pragma pack(pop)

#pragma pack(push,1)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_ALL_RFID_AND_NODE_ID_INFO)
	int32			iCount;
	RFID_DATA_TYPE	i64RFIDArray[TOTAL_CARD_COUNT];
	uint8			ui8NodeIDArray[TOTAL_CARD_COUNT];
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_ALL_RFID_AND_NODE_ID_INFO)
#pragma pack(pop)

#pragma pack(push,1)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_COLLISION_TEST)
	bool bHitted;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_COLLISION_TEST)
#pragma pack(pop)


#pragma pack(push,1)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_C2S_CAR_EXCEPTION_HAPPEN)
	int		iCarID;
	int		iCarExceptionCode;
	bool	bSetCarInProblem;//only show message not set car in problem.
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_C2S_CAR_EXCEPTION_HAPPEN)
#pragma pack(pop)

LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_LID_MOTOR_STATUC_CHANGE_REQUEST)
	int		iCarID;
	bool	bOpen;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_LID_MOTOR_STATUC_CHANGE_REQUEST)


LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_STAR(eCDNM_C2S_LID_MOTOR_STATUC_CHANGE_RESULT)
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_END(eCDNM_C2S_LID_MOTOR_STATUC_CHANGE_RESULT)

LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_TABLET_SEND_CAR_REJOIN_REQUEST)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_TABLET_SEND_CAR_REJOIN_REQUEST)
...
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_C2S_SEND_CAR_DRIVING_ROUTE_DATA)
	int		iCarID;
	int		iDataCount;
	char    strRouteName[PATH_NAME_LENGTH];
	sCarDrivingPathData Data[ROUTE_KEY_POINT_DATA_LENGTH];
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_C2S_SEND_CAR_DRIVING_ROUTE_DATA)


LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_TIME_SYNC)
	int32	i32Time;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_TIME_SYNC)


LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_TEST_PLAN_FOR_LOG)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_TEST_PLAN_FOR_LOG)



#pragma pack(push,1)// push current alignment to stack,set alignment to n byte boundary
LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_ROUTE_EXPEND_REQUEST)
	//node(RFID) count
	int								iCount;//or do if Tag ID is -1 end?,2
	int								iSmallPartDataCount;
	int								iCarID;
	...
	uint8							ui8NodeIDArray[CAR_A_TO_B_DATA_LENGTH];//160
	sRouteDividedIntoSmallPartData	RouteDividedIntoSmallPartDataArray[ROUTE_KEY_POINT_DATA_LENGTH];
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_ROUTE_EXPEND_REQUEST)
#pragma pack(pop)

#pragma pack(push,1)
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_STAR(eCDNM_C2S_ROUTE_EXPEND_RESULT)
	int	iCarID;
	int	iCount;
LAZY_RESULT_WITH_UNIQUE_MESSAGE_HEADER_END(eCDNM_C2S_ROUTE_EXPEND_RESULT)
#pragma pack(pop)

LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_LCD_SHOW_TEXT)
		char	strText[256];
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_LCD_SHOW_TEXT)

LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_S2C_LID_LIGHT_TEST)
	bool bOn;
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_S2C_LID_LIGHT_TEST)

LAZY_MESSAGE_WITH_UNIQUE_HEADER_STAR(eCDNM_C2S_WEIGHT_ZERO_REQUEST)
LAZY_MESSAGE_WITH_UNIQUE_HEADER_END(eCDNM_C2S_WEIGHT_ZERO_REQUEST)
