...
//Jan/27/2021
//eTANME_TA2S2DBS_CREATE_NEW_TEST_REQUEST add int64	i64CarSN;

#define	TEST_APP_NETWORK_VERSION		20210127
...
enum eTestAppNetworkMessageEnum
{
	...
	eTANME_DBS2CDS_ADD_CAR_ROUTE_DATA_RESULT,//20005
	//
	...
	//
	eTANME_TA2DBS_QUERY_CAR_RESULT_HISTORY_REQUEST,//20010
	eTANME_DBS2TA_QUERY_CAR_RESULTHISTORY_RESULT,
	//
	eTANME_S2TA_PROGRESS_UPDATE,//20012
	//
	eTANME_S2DBS_ADD_CAR_STATUS_DATA_REQUEST,
	eTANME_MAX
};
...
LAZY_MESSAGE_HEADER_STAR(eTANME_S2TA_PROGRESS_UPDATE)
	float	fProgress;
LAZY_MESSAGE_HEADER_END(eTANME_S2TA_PROGRESS_UPDATE)




LAZY_MESSAGE_HEADER_STAR(eTANME_S2DBS_ADD_CAR_STATUS_DATA_REQUEST)
	//key filter
	int64	i64StartTime;
	int		iNodeID;
...
LAZY_MESSAGE_HEADER_END(eTANME_S2DBS_ADD_CAR_STATUS_DATA_REQUEST)