...
//20211012	add eCGANM_INFO_NOTIFY
#define		CAR_GO_APP_TCP_IP_PORT				5978
#define		CAR_GO_APP_WEBSOCKET_PORT			9991
//#define		CAR_GO_APP_NETWORK_MESSAGE_VERSION	20211124
...
LAZY_MESSAGE_HEADER_STAR(eCGANM_INFO_NOTIFY)
	char	strInfo[250];
	char	strSoundName[100];
	//float	fShowSeconds;
LAZY_MESSAGE_HEADER_END(eCGANM_INFO_NOTIFY)
