...
//20211012	add eCGANM_S2C_INFO_NOTIFY
//20211202	add eCGANM_S2C_AWS_LICENCE_OVERDUE_INFO
#define		CAR_GO_APP_TCP_IP_PORT				5978
#define		CAR_GO_APP_WEBSOCKET_PORT			9991
#define		CAR_GO_APP_NETWORK_MESSAGE_VERSION	20211202
//#define		CAR_GO_APP_NETWORK_MESSAGE_VERSION	20210428
...
{
	eCGANM_C2S_VERSION_AND_MAP_INFOR_REQUEST = 100000,//tell me your deliver point and map infomation and else...
	...
	eCGANM_C2S_QUERY_DELIVER_POINT_CAR_INFORMATION_REQUEST,
	...
	//
	eCGANM_C2S_CHANGE_PARAMETER_SETTING_REQUEST,//10020
	...
	//
	//20210325,
	eCGANM_C2S_ASK_TRAFFIC_START_REQUEST,
	eCGANM_S2C_ASK_TRAFFIC_START_RESULT,
	//20211019 stanley
	eCGANM_C2S_WEIGHT_ZERO_REQUEST,
	eCGANM_S2C_WEIGHT_ZERO_RESULT,
	//20211012,show toast and play sound let user get new info.
	eCGANM_S2C_INFO_NOTIFY,
	//
	eCGANM_S2C_AWS_LICENCE_OVERDUE_INFO,
	//
	eCGANM_C2S_LAZY_PARAMETER_CHANGE,
	//
	eCGANM_MAX,
};
//
...
////=====================================
LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_VERSION_AND_MAP_INFOR_REQUEST)
	int		iVersion;//CAR_GO_APP_NETWORK_MESSAGE_VERSION
	char	strMapName[MAP_NAME_ARRAY_LENGTH];//Maps/Wang_DoubleCow.xml
LAZY_MESSAGE_HEADER_END(eCGANM_C2S_VERSION_AND_MAP_INFOR_REQUEST)
//
...
LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_REQUIRE_DELIVER_POINT_INFO_REQUEST)
LAZY_MESSAGE_HEADER_END(eCGANM_C2S_REQUIRE_DELIVER_POINT_INFO_REQUEST)
...
LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_SELECTED_DELIVER_POINT_REQUEST)
...
LAZY_MESSAGE_HEADER_END(eCGANM_C2S_SELECTED_DELIVER_POINT_REQUEST)
...
LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_CAR_GO_REQUEST)
...
//show error message
LAZY_RESULT_MESSAGE_HEADER_STAR(eCGANM_S2C_CAR_ACCIDENT_HAPPEN)
	int		iCarID;
	int		iNodeID;
	int		iInProblem;//0 false; 1 yes
#if CAR_GO_APP_NETWORK_MESSAGE_VERSION == 20210428
	int		iExceptionCode[2];
#else
	int		iExceptionCode;
#endif
LAZY_RESULT_MESSAGE_HEADER_END(eCGANM_S2C_CAR_ACCIDENT_HAPPEN)
...
{
	int		CarID;//-1 no more data
	int		CarCurrentCustomerTableID;//
	int		CarTargetCustomerTableID;//-1 going to wait point
};
...
LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_ASK_TRAFFIC_START_REQUEST)
	int	iNumCar;
LAZY_MESSAGE_HEADER_END(eCGANM_C2S_ASK_TRAFFIC_START_REQUEST)


LAZY_RESULT_MESSAGE_HEADER_STAR(eCGANM_S2C_ASK_TRAFFIC_START_RESULT)
	int		iNumCar;
	bool	bTrafficStart;
	int16	i16CarIDArray[MAX_CAR_COUNT];
	int16	i16CarNodeIDArray[MAX_CAR_COUNT];
LAZY_RESULT_MESSAGE_HEADER_END(eCGANM_S2C_ASK_TRAFFIC_START_RESULT)

LAZY_MESSAGE_HEADER_STAR(eCGANM_S2C_INFO_NOTIFY)
	char	strInfo[250];
	char	strSoundName[100];
	//float	fShowSeconds;
LAZY_MESSAGE_HEADER_END(eCGANM_S2C_INFO_NOTIFY)

LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_WEIGHT_ZERO_REQUEST)
	int		iCarID;
LAZY_MESSAGE_HEADER_END(eCGANM_C2S_WEIGHT_ZERO_REQUEST)



LAZY_MESSAGE_HEADER_STAR(eCGANM_S2C_AWS_LICENCE_OVERDUE_INFO)
	int		iCarID[MAX_CAR_COUNT];//-1 no car.
LAZY_MESSAGE_HEADER_END(eCGANM_S2C_AWS_LICENCE_OVERDUE_INFO)

enum eLazyCommandEnum
{
	eLCE_SOUND_VOLUME_CHANGE = 0,
	eLCE_SERVER_MOVING_PARAMETER_RELOAD,
	eLCE_MAX
};

LAZY_MESSAGE_HEADER_STAR(eCGANM_C2S_LAZY_PARAMETER_CHANGE)
	int		iCommandID;
	char	CommandDataArray[260];
LAZY_MESSAGE_HEADER_END(eCGANM_C2S_LAZY_PARAMETER_CHANGE)