...
LAZY_HEADER_STAR(eARM_A2R_VERSION_RESULT)
	uint32	ui32Version;
	uint32	ui32ErrorCode;//0 version not match,1 version matched
...
//	l_Data.ui16TagID = 7;
//
//	l_Data.i16CheckSum = BufferAndSizeGetCheckSum((unsigned char*)&l_Data, sizeof(sStreamingData_eARM_A2R_HWARDWARE_INFO));
